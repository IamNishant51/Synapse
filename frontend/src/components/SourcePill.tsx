...
const sourceIcons: Record<SourceType, React.ReactNode> = {
  pdf: (
    <svg width="14" height="14" viewBox="0 0 14 14" fill="none">
      <path d="M2 1.5H8.5L12 5V12.5H2V1.5Z" stroke="#8a8f98" strokeWidth="1.2" />
      <path d="M8.5 1.5V5H12" stroke="#8a8f98" strokeWidth="1.2" />
    </svg>
  ),
  github: (
    <svg width="14" height="14" viewBox="0 0 14 14" fill="none">
  ...
  conversation: (
    <svg width="14" height="14" viewBox="0 0 14 14" fill="none">
      <path d="M1 7C1 3.5 3.5 1 7 1C10.5 1 13 3.5 13 7C13 10.5 10.5 13 7 13H1V7Z" stroke="#8a8f98" strokeWidth="1.2" />
    </svg>
  ),
  article: (
    <svg width="14" height="14" viewBox="0 0 14 14" fill="none">
      <path d="M1 2H13V11H1V2Z" stroke="#8a8f98" strokeWidth="1.2" />
      <path d="M3 5H11" stroke="#8a8f98" strokeWidth="1.2" />
      <path d="M3 7.5H9" stroke="#8a8f98" strokeWidth="1.2" />
    </svg>
  ),
  youtube: (
    <svg width="14" height="14" viewBox="0 0 14 14" fill="none">
      <rect x="1" y="3" width="12" height="8" rx="2" stroke="#8a8f98" strokeWidth="1.2" />
      <path d="M6 5.5L8.5 7L6 8.5V5.5Z" fill="#8a8f98" />
    </svg>
  ),
};
