      ...
      <div ref={cardRef} className="relative z-10 w-full max-w-sm mx-auto px-6 animate-fade-up">
        ...
        <div className="bg-[var(--color-surface-card)] border border-[var(--color-hairline)] rounded-2xl p-6 shadow-[0_4px_24px_rgba(0,0,0,0.03)]">
          ...
          <div className="flex flex-col gap-2">
            <button
              onClick={() => router.push("/graph?demo=true")}
              className="group relative flex items-center justify-center gap-2 w-full px-5 py-3 rounded-xl bg-[var(--color-ink)] text-[var(--color-canvas)] hover:opacity-90 transition-all duration-200 text-sm font-medium cursor-pointer"
            >
              <svg className="w-4 h-4" fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                <path strokeLinecap="round" strokeLinejoin="round" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" />
              </svg>
              <span>View demo without signing in</span>
            </button>
