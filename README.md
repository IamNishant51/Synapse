...
[![CI](https://github.com/IamNishant51/Synapse/actions/workflows/ci.yml/badge.svg)](https://github.com/IamNishant51/Synapse/actions/workflows/ci.yml)
[![PRs Welcome](https://img.shields.io/badge/PRs-welcome-brightgreen.svg)](CONTRIBUTING.md)
**[Live Demo](https://synapsememory.vercel.app)** |

**Built by [Nishant Unavane](https://nishantunavane.qzz.io)**

## Quick Access

**Live demo:** [https://synapsememory.vercel.app](https://synapsememory.vercel.app)
...
|---|---|---|
| `remember()` | [services/__init__.py](https://github.com/IamNishant51/Synapse/blob/main/backend/services/__init__.py) | Ingests PDF files, GitHub repositories, ChatGPT exports, articles, and YouTube transcripts. |
| `recall()` | [services/__init__.py](https://github.com/IamNishant51/Synapse/blob/main/backend/services/__init__.py) | Powers graph-grounded, time-aware chat queries ("what did I believe before vs now"). |
| `improve()` / `cognify()` | [services/__init__.py](https://github.com/IamNishant51/Synapse/blob/main/backend/services/__init__.py) | Runs the `cognify` step to build the graph, and the Reconciliation Pass to detect semantic conflicts and update confidence weights. |
| `forget()` | [services/__init__.py](https://github.com/IamNishant51/Synapse/blob/main/backend/services/__init__.py) | Enables user-triggered manual pruning, source-level forgetting, and automatic decay of stale nodes. |
...
- **Backend**: FastAPI (Python), SQLite/PostgreSQL metadata database ([database.py](https://github.com/IamNishant51/Synapse/blob/main/backend/database.py)), Cognee SDK, Gemini / Groq API wrappers.
...
Look for issues tagged [`good first issue`](https://github.com/IamNishant51/Synapse/issues?q=is%3Aissue+is%3Aopen+label%3A%22good+first+issue%22) for well-scoped starting points.
